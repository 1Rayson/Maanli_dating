...
class MySQL {
    ...
    private $server = "mysql28.unoeuro.com"; // Change to domain name, e.g. www.iloveunicorns.com
    private $username = "linemerrildnielsen_dk"; // Change to the admins username of the server
    private $password = "mw9nBaEDz64H"; // Change to the admins password of the server
    private $database = "linemerrildnielsen_dk_db_eaaa"; // Change to the name of the database you would like to connect to on the server
